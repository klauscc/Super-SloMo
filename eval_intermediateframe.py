...
def interpolate_singleframe():
    ...
    frame1s = sorted(glob.glob('../UCF101_results/ucf101_superslomo_adobe240fps/*/*00.png'))
    frame2s = sorted(glob.glob('../UCF101_results/ucf101_superslomo_adobe240fps/*/*02.png'))
    ...
    for frame1_path, frame2_path in zip(frame1s, frame2s):
        ...
        for int_frame in intermediate_frames:
            ...
            frame.save(
                os.path.join('../UCF101_results/ucf101_superslomo_adobe240fps/%s/frame_01_slomo_reimplement.png' %
                             (framename[-2])), 'PNG')
