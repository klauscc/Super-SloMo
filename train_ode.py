...
parser.add_argument(
    ...
    default=[100, 150],
    help=
    'Set to epoch values where you want to decrease learning rate by a factor of 0.1. Default: [100, 150]'
)
parser.add_argument(
    "--progress_iter",
    type=int,
...
parser.add_argument("--lr_scheduler", type=str, default="step", help="the scheduler: step, exp")
args = parser.parse_args()

##[TensorboardX](https://github.com/lanpa/tensorboardX)
### For visualizing loss and interpolated frames

workspace = args.checkpoint_dir
ckpt_dir = os.path.join(workspace, "ckpt")
summary_dir = os.path.join(workspace, "tensorboard")
...
def validate():
    ...
    with torch.no_grad():
        for validationIndex, (validationData,
                              validationFrameIndex) in enumerate(validationloader, 0):
    ...
    for trainIndex, (trainData, trainFrameIndex) in enumerate(trainloader, 0):
        ...
        if ((trainIndex % args.progress_iter) == args.progress_iter - 1):
            ...
            print(
                ...
                % (iLoss / args.progress_iter, trainIndex, len(trainloader), end - start, vLoss,
                   psnr, endVal - end, get_lr(optimizer)))
